# Aula: Lista de Dados em Python

# Introdução às Listas
# Em Python, uma lista é uma coleção de itens que são ordenados e mutáveis. 
# As listas permitem armazenar diferentes tipos de dados, como números, strings e até outras listas.
